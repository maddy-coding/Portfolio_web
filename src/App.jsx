      ...
      >
        ...
        <section id="about" className="max-w-4xl mx-auto py-20 px-6">
          ...
          <p className="text-lg text-gray-600 leading-relaxed text-center mb-8">
            ...
            empathy, and pixel-perfect precision to turn complex ideas into
            clean, engaging interfaces.
          </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <ul className="list-disc ml-6 text-gray-700">
                ...
                <li>
                  Created wireframes and prototypes for residents and admins
                </li>
            ...
            <div className="mb-16">
              ...
              <p className="text-gray-600 mb-4">
                ...
                centralized dashboard for assignments, attendance, and
                performance tracking.
              </p>
              <ul className="list-disc ml-6 text-gray-700">
                <li>Defined user personas for teachers and students</li>
                <li>
                  Designed responsive dashboard with intuitive data
                  visualization
                </li>
            ...
            <div>
              ...
              <ul className="list-disc ml-6 text-gray-700">
                ...
                <li>
                  Integrated credibility indicators like reviews and
                  verification
                </li>
